...
const developers = [
  {
    ...
    email: "bhavish.pushkarna2005@example.com",
...
const Footer = () => {
  return (
    <div className="relative bg-gradient-to-tr from-slate-900 via-slate-800 to-slate-900 text-gray-300 border-t border-slate-800">
